  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between rounded-card border border-info/30 bg-info/10 px-4 py-3 text-sm text-info">
        <span>
          ℹ 素材库为 V1.1 能力，当前为效果预览；上传与智能混剪将在素材库版本开放
        </span>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          <div className="glass flex min-h-48 items-center justify-center border-dashed p-3 text-text-3">
            ＋ 上传新素材
          </div>
        </div>
      </div>
