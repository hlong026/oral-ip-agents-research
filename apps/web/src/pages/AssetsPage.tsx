...
const MATERIALS: { icon: LucideIcon; name: string; tags: string[] }[] = [
  { icon: Image, name: "节税系列封面 · 红底", tags: ["封面", "常用"] },
  { icon: Music, name: "轻快商务 BGM", tags: ["BGM", "0:58"] },
  { icon: Film, name: "开场钩子片段包（8 条）", tags: ["视频片段"] },
  { icon: Sparkles, name: "李老师角标水印", tags: ["水印", "默认启用"] },
  { icon: Image, name: "新公司法封面 · 蓝底", tags: ["封面"] },
  { icon: Music, name: "悬念感 BGM", tags: ["BGM", "0:41"] },
  { icon: Film, name: "办公室空镜 B-roll", tags: ["视频片段", "4 条"] },
];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-1.5 rounded-card border border-info/30 bg-info/10 px-4 py-3 text-sm text-info">
        ...
        <span>
          上传的素材仅用于您自己的视频合成；BGM
          区提供平台曲库授权曲目，商用无忧。合成时可在「模板中心」为每个 IP
          设定默认素材组合。
        </span>
      </div>
    </div>
